...
and note the eventX device of keyboard and mouse

4. in raw input at the top of void start . is string? dev = "/dev/input/event7";. change that line to what ever event number you got
